#!/bin/bash
# land-the-money-the-city-never-saw.sh — the spending log's foundation: a table,
...
verify 49ca838d149f3491f30bf0b6369a5ecec33587e6662e0b26c75cd2eb3db853a2 src/financial/a-log-is-not-a-ledger.spec.ts
