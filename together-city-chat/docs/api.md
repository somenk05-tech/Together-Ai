...
Every path below is prefixed with `/api`. **665 routes** across
...
| GET | `/api/dev/media/analytics/:id` | 🔒 |
| POST | `/api/dev/media/analytics/refresh` | 🔒 |
| GET | `/api/dev/media/analytics` | 🔒 |
...
_insights/insights.controller.ts_

| Method | Path | Auth |
|---|---|---|
| POST | `/api/insights/beat` | 🔒 |
| GET | `/api/insights` | 🔒 |
| GET | `/api/insights/investor` | **public** |
| POST | `/api/insights/origin` | 🔒 |
| POST | `/api/insights/session` | **public** |
