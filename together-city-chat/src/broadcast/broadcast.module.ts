...
import { ThreadsDeskService } from './threads-desk.service';
...
@Module({
  ...
  providers: [BroadcastService, SocialAccountsService, ContentAnalyticsService, ThreadsDeskService, DevPasswordGuard],
})
