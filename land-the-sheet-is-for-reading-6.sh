#!/bin/bash
# land-the-sheet-is-for-reading-6.sh — the readability pass on the two sheets,
# and a week that stops printing one sentence seven times.
#
# -6 fixes the family planner contradicting itself about who is eating.
#
...
ALLOWED='^((M | M|MM) together-city-react/src/(styles/(tokens|relief)\.css|features/(nutrition/(dayBalance\.ts|pages/MealPlan\.tsx)|family/pages/Weekly\.tsx)))$'
...
verify 762087efddb38e597fff0b5b50a9f5170ed2c66c5f347e6c9323b3b78b6e97b1 src/features/nutrition/pages/MealPlan.tsx
verify bdb9048e9ee45747e01e7a588621cca58c91c7ce9cfd8dc22562c4fd26a4a784 src/features/family/pages/Weekly.tsx
echo "== five files verified"
