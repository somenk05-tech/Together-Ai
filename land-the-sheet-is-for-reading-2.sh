#!/bin/bash
# land-the-sheet-is-for-reading-2.sh — the readability pass on the two sheets,
# and a week that stops printing one sentence seven times.
#
# -2 because the day sheet was printing the same five figures twice — `Daily
...
verify 146f29e23103de8373eca5b16da8d3a3ad71ce75ebfc8dc44821431ccc82d1e1 src/features/nutrition/pages/MealPlan.tsx
...
===============================================================
 ...
 per sheet, and no two days should open with the same sentence
 unless the week is four days long.
===============================================================
