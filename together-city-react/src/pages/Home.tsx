 ...
 */
/* SEVEN DISTRICTS TAKE A SENTENCE FOR A NAME (owner, 16 Sep), the same one
   their hub title wears (hubs.ts): Beauty, Fitness, Nutrition, Medical,
   Matchmaking, Astrology and Pets. It replaces "ASTRA — Astrology" and "Pet
   Products" below; the notes on those two are kept for why they differed. */
