        ...
        {done ? (
          ...
          <>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 14, alignItems: 'center' }}>
              <Button variant="accent" disabled={!target || busy} onClick={() => void send()} state={busy ? 'loading' : undefined} loadingLabel="Sending…">{target ? `Send to ${target.label}` : 'Pick a chat'}</Button>
