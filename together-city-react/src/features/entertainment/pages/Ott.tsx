...
import { KIT_CSS, TitleSheet, type TitleSel } from './movieKit';
...
export function Ott() {
  ...
  return (
    <EntPage className="ent-ott">
      <style>{CSS}</style>
      <PosterLead eyebrow="Entertainment · 02" title="OTT Watch" sub="What to stream tonight — live trending across every platform you already pay for." />

      {live.isLoading && <Spinner label="Loading what's trending…" />}
      {!live.isLoading && !isLive && (
