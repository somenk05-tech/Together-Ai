            ...
            <form onSubmit={submit}>
              {mode === 'login' && (
                <>
                  ...
                  <input required type="password" value={password} placeholder="Password" name="current-password" autoComplete="current-password"
                    onChange={(e) => setPassword(e.target.value)} className="tc-field" style={field} />
                </>
              )}

              {(mode === 'forgot' || mode === 'reset') && (
                <input required autoFocus={mode === 'forgot'} value={identifier} placeholder="Your primary email, phone, or handle"
                  onChange={(e) => setIdentifier(e.target.value)} className="tc-field" style={field} />
              )}
              {mode === 'forgot' && (
