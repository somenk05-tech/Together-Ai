    ...
    <div className="page">
      ...
      <div className="hero rise" style={{ position: 'relative', minHeight: 300, borderRadius: 'var(--radius-lg)', overflow: 'hidden', display: 'flex', alignItems: 'flex-end', color: 'var(--on-accent)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '0 40px 40px', maxWidth: 760 }}>
          ...
          <h1 style={{ color: 'var(--on-accent)', fontSize: 'clamp(28px,4vw,48px)', margin: '4px 0 8px', textShadow: '0 2px 24px rgba(0,0,0,.5)' }}>Exceptional dining, curated for you</h1>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 18, flexWrap: 'wrap' }}>
            ...
            <Link className="btn btn-line btn-sm" to="/restaurants/decide" style={{ color: 'var(--on-accent)', borderColor: 'rgba(255,255,255,.5)' }}>Decide what to eat</Link>
          </div>
        </div>
      </div>
