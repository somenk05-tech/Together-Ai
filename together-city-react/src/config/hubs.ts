...
export const HUBS: Record<HubKey, HubConfig> = {
  ...
  nutrition: {
    ...
    items: [
      ...
      { path: '/nutrition/health', index: '07', label: 'My Health Profile', sub: 'Tracker, macros & journal' },
      { path: '/nutrition/orders', index: '08', label: 'My Orders', sub: 'Deliveries & wallet' },
      { path: '/nutrition/recipes', index: '09', label: 'Recipes', sub: '11,254-recipe world DB' },
      { path: '/nutrition/supplements', index: '10', label: 'Supplements', sub: 'Goal-matched kit' },
      { path: '/nutrition/dietitian', index: '11', label: 'Expert Care', sub: 'Talk to a dietitian' },
    ],
  },
  family: {
