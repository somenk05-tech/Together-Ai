...
export const HUBS: Record<HubKey, HubConfig> = {
  ...
  nutrition: {
    ...
    items: [
      ...
      { path: '/nutrition/daily', index: '04', label: 'Daily Meal Planner', sub: "Today's plate" },
  ...
  social: {
    ...
    items: [
      ...
      { path: '/social/circle', index: '03', label: 'Circles', sub: 'Your communities' },
      { path: '/social/create', index: '04', label: 'Create Post', sub: 'Share a photo, video or plan' },
      { path: '/social/map', index: '05', label: 'City Map', sub: 'Outdoor posts pinned nearby' },
      { path: '/social/messages', index: '06', label: 'Messages', sub: 'Direct conversations' },
      { path: '/social/notifications', index: '07', label: 'Notifications', sub: 'Likes, comments & mentions' },
      { path: '/social/profile', index: '08', label: 'My Profile', sub: 'Story, stats & Post & Earn' },
      { path: '/social/saved', index: '09', label: 'Saved', sub: 'Bookmarked posts & places' },
    ],
  },
  dating: {
  ...
  medical: {
    ...
    items: [
      ...
      { path: '/medical/records', index: '03', label: 'Health Records', sub: 'Conditions, reports, allergies' },
      { path: '/medical/consults', index: '04', label: 'Talk to a Doctor', sub: 'Book a connection-gated consult' },
      { path: '/medical/booking', index: '05', label: 'Book Appointment', sub: 'Confirm your consult slot' },
      { path: '/medical/timeline', index: '06', label: 'Health Timeline', sub: 'Longitudinal history' },
      { path: '/medical/family', index: '07', label: 'Family Profiles', sub: 'Records, allergies & reminders' },
      { path: '/medical/insurance', index: '08', label: 'Health Insurance', sub: 'Compare, buy & manage' },
      { path: '/medical/emergency', index: '09', label: 'Emergency', sub: 'One-tap SOS & medical ID' },
      { path: '/medical/supplements', index: '10', label: 'Supplement Plan', sub: 'From your labs & goal' },
      { path: '/medical/connections', index: '11', label: 'Connections', sub: 'Who can read your data' },
      { path: '/medical/consent', index: '12', label: 'Privacy & Consent', sub: 'Consent controls' },
    ],
  },
  realestate: {
  ...
  jobs: {
    ...
    items: [
      ...
      { path: '/jobs/matches', index: '02', label: 'Matched Roles', sub: 'Ranked by fit' },
      { path: '/jobs/applications', index: '03', label: 'My Applications', sub: 'Track your applies' },
      { path: '/jobs/post', index: '04', label: 'Post a Job', sub: 'For employers' },
      { path: '/jobs/postings', index: '05', label: 'My Postings', sub: 'See your applicants' },
    ],
  },
  fitness: {
