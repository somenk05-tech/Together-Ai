#!/usr/bin/env bash
# land-a-project-is-a-folder.sh  ·  run from the REPO ROOT
#
...
ALLOWED_IN='^(M |MM| M|\?\?) (together-city-chat/(prisma/(schema\.prisma|migrations/20260814020000_mail_project_look/)|src/mail/(mail\.service\.ts|dto/mail\.dto\.ts))|together-city-react/src/(index\.css|styles/tokens\.css|components/ui/Icon\.tsx|features/mail/(api\.ts|folderLook\.ts|folderLook\.test\.ts|pages/(Projects|Folders)\.tsx)))$'
...
verify 97e190a832f492db4027cb7a8c556a5e01f7b62caa808b12f53d59a36b8cc8aa "$W/src/features/mail/pages/Projects.tsx"
